                    ...
                    <div class="col-md-4" style="border: 1px solid #ccc; border-radius: 5px; padding: 1rem">
                        ...
                        <form action="checkout" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" required id="phone" name="phone" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                            ...
                            <div id="qrCodeContainer" class="text-center mt-3" style="display: none;">
                                <h4>Scan QR Code to Proceed with Payment</h4>
                                <img src="https://www.bleepstatic.com/images/news/u/1164866/2022/Apr-2022/qr-code-moving/qr-code-moving.gif" alt="QR Code" />
                            </div>
                            <script>
                                document.getElementById("paymentMethod").addEventListener("change", function () {
                                    var selectedValue = this.value;
                                    if (selectedValue === "cashOnDelivery") {
                                        window.location.href = "thanks.jsp"; // Thay đổi đường dẫn đến trang thanh toán khi nhận hàng
                                    }
                                });
                            </script>
                            <script>
                                document.getElementById("paymentMethod").addEventListener("change", function () {
                                    ...
                                    if (selectedValue === "onlinePayment") {
                            ...
                            <!-- Nơi hiển thị mã QR -->
                            <d/.iv id="qrCodeContainer"></div>
                                <!-- Nút xác nhận thanh toán -->
                                <button id="confirmPaymentButton" class="btn btn-primary w-100">Confirm Payment</button>
                        </form>
                    </div>
                </div>
            </div>
